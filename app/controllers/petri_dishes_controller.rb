class PetriDishesController < ApplicationController
  ...
  private
    ...
    def petri_dish_params
      params.require(:petri_dish).permit(:name, :inoculated, :inoculated_at, :run_started, :run_started_at, :fully_colonized, :fully_colonized_at, :recipe, :description, :protocol, :mushroom_id, :agar_recipe_id, :sample, :percent_complete)
    end
end
